...
fetch(CSV_URL)
  ...
  function buildWhatsAppLink(raw) {{
    ...
    const FONTS_URL =
      'https://script.google.com/macros/s/AKfycbxZMZlAi1jUtJ3DVuWoQyaRzvMoDku3KLOdrPVP8xmpIN2s-O7avujf8YGNuV8fvlyc/exec?action=fonts&sheet_url=' +
    ...
    const COLORS_URL =
      'https://script.google.com/macros/s/AKfycbxZMZlAi1jUtJ3DVuWoQyaRzvMoDku3KLOdrPVP8xmpIN2s-O7avujf8YGNuV8fvlyc/exec?action=colors&sheet_url=' +
      encodeURIComponent("{sheet_url}");
