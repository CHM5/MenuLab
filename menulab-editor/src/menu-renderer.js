...
<section id="formato">
  <button id="btnFormato">Formato</button>
  <div id="gridFormatos" class="oculto">
    ...
    <div class="categoria-options">
      <label><input type="radio" name="category-position" value="left"> Categorías a la izquierda</label>
      <label><input type="radio" name="category-position" value="center"> Categorías centradas</label>
      <label><input type="radio" name="category-position" value="right"> Categorías a la derecha</label>
    </div>
  </div>
</section>