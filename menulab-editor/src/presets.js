...
<section id="formato">
  ...
  <div id="formatoOptions" style="display: none;">
    <div class="grid-opciones">
      ...
      <button data-format="2-columns-left-header">2 Columnas (Header a la izquierda)</button>
      <button data-format="3-columns-centered">3 Columnas (Header centrado)</button>
      <button data-format="3-columns-left-header">3 Columnas (Header a la izquierda)</button>
    </div>
    <div>
      <h4>Categorías</h4>
